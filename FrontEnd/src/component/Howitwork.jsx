...
function Howitwork() {
  ...
  return (
    <>
      ...
      <h2 className="text-center text-3xl md:text-3xl xl:text-3xl font-bold tracking-tight mb-3 text-blue-600">
            Only 3 steps <br />
      ...
      {/* </div>  */}
      <div>    
          <section className="bg-white mt-10 p-10 dark:bg-gray-900">
          {/* <div className="flex flex-col justify-center mt-16 mb-10 items-center py-4">
      <h2 className="text-center text-3xl font-extrabold md:text-3xl xl:text-3xl font-bold tracking-tight mb-3 text-cyan-400">
            Only 3 steps <br />
            <span className=' text-gray-800'>Away after Registeration</span>
      </h2>
      </div> */}
