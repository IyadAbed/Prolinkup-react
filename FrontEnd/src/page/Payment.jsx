...
function Payment() {
  ...
  <div className="flex justify-center min-h-screen grid-cols-10">
    <div className="py-6 px-4 sm:py-12 lg:py-24">
      <div className="mx-auto w-full max-w-lg">
        <h1 className="relative text-2xl font-medium text-gray-700 sm:text-3xl">
          Secure Checkout
          <span className="mt-2 block h-1 w-10 bg-teal-600 sm:w-20" />
        </h1>
        <form action="" className="mt-10 flex flex-col space-y-4" onSubmit={handleSubmit}>
          <div>
            <label
              htmlFor="email"
