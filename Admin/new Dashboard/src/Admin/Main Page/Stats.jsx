...
export const Stats = (props) => {
  ...
  return (
    <div className="stats stats-vertical xl:stats-horizontal md:stats-horizontal bg-white shadow-lg ">
      <div className="stat">
        <div className="stat-title  text-[#529b03] font-bold">Total Project's</div>
      ...
      <div className="stat">
        ...
        <div className="stat-title text-[#529b03] font-bold">Total Report's</div>
      ...
      <div className="stat">
        ...
        <div className="stat-title  text-[#529b03] font-bold">Total User's </div>
