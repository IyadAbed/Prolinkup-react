        ...
        <div className="lg:px-20 md:px-6 px-4 md:py-12 py-8">
            <div className="lg:flex items-center justify-between">
                <div className="lg:w-1/3">
                    ...
                    <button aria-label="view catalogue" className="btn btn-primary focus:ring-2 focus:ring-offset-2 focus:ring-gray-700 focus:outline-none mt-6 md:mt-8 text-base font-semibold leading-none text-gray-800 flex items-center hover:underline">
                        View Catalogue
                ...
                <div className="lg:w-7/12 lg:mt-0 mt-8">
                    <div className="w-full h-full bg-red-200">
                        <img src={La} alt="apartment design" className="w-full sm:block hidden" />
                        <img src={La} alt="apartment design" className="sm:hidden block w-full" />
                    </div>
